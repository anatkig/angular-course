...
export const course: Course = {
  ...
  description:
    'A comprehensive course covering everything from TypeScript fundamentals to Angular components, services, routing, RxJS, state management, testing, and deployment best practices.',
