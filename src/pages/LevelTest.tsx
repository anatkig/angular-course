...
const levelDescriptions: Record<Level, string> = {
  'Beginner': 'You\'re just getting started with Angular. We recommend beginning from Module 1 and working through the entire course.',
  'Intermediate': 'You know the basics! Focus on Modules 4–7 to strengthen your understanding of services, dependency injection, and routing.',
  'Advanced': 'Solid foundation! Check out Modules 8–12 covering reactive forms, RxJS, state management, and HTTP interceptors.',
  'Proficient': 'You have strong Angular skills. Review Modules 13–16 for advanced patterns like lazy loading, custom directives, testing, and performance optimization.',
  'Highly Proficient': 'Excellent Angular knowledge! You can go straight to the final test, or browse specific topics for a refresher.',
};
  ...
  return (
    <div className="page">
      ...
      <p className="subtitle">
        30 randomly selected questions to evaluate your Angular proficiency level.
      ...
      {!progress.levelTestResult && (
        <Quiz
          key={questions[0]?.id}
          title="Angular Knowledge Assessment"
          questions={questions}
